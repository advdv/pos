...
func TestF2(t *testing.T) {
	...
	f2y1 := Fx(params, proof[:2]...) // f2(x1, x2)
...
func TestF3(t *testing.T) {
	...
	f3y1 := Fx(params, proof[:4]...) // f2(x1, x2, x3, x4)
...
func TestF4(t *testing.T) {
	...
	f3y1 := Fx(params, proof[:8]...) // f2(x1, ... x8)
...
func TestF5(t *testing.T) {
	...
	f3y1 := Fx(params, proof[:16]...) // f2(x1, ... x16)
	require.Equal(t, "031b1111100110111000011001100111001", fmt.Sprint(f3y1))
}
...
func TestF6(t *testing.T) {
	...
	f3y1 := Fx(params, proof[:32]...) // f2(x1, ... x32)
	require.Equal(t, "031b1001011111000001110101101111011", fmt.Sprint(f3y1))
}
...
func TestF7(t *testing.T) {
	...
	f3y1 := Fx(params, proof[:64]...) // f2(x1, ... x64)
	require.Equal(t, "031b0001000000000000000000000001001", fmt.Sprint(f3y1))
}

func TestInvalidFx(t *testing.T) {
	require.Panics(t, func() { Fx(nil, []Num{{}, {}, {}}...) })
}
